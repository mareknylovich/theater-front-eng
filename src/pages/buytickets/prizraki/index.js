              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Direction:</strong>&nbsp;— Grigory Dityatkovsky
                    </p>
                    <p>
                      <strong>Production designer</strong>&nbsp;— Emile Capelouche
                    </p>
                    <p>
                      <strong>Lighting designer</strong>&nbsp;— Igor Fomin
                    </p>
                    <p>
                      <strong>Costume Designer</strong>&nbsp;— Irina Tsvetkova
                    </p>
                    <p>
                      <strong>Sound engineer</strong>&nbsp;— Alexey Rodichev
                    </p>
                    <p>
                      <strong>Director of plastics&nbsp;plastics</strong>&nbsp;— Honoured artist
                      of Ukraine, State Prize winner Sergey Gritsay
                    </p>
                    <p>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      Pasquale Loiacono, a middle-aged entrepreneur who is very active, tries in
                      in vain to find work. He accepts a dubious offer of free lodgings in an abandoned
                      accommodation in an abandoned mansion that is supposed to be haunted, and decides to
                      decides to set up a guest house, and tries to persuade the porter, Raffaele,
                      to become his companion. He&nbsp;will stop at nothing
                      in&nbsp;his&nbsp;desire&amp;to&amp;be rich,&amp;
                      he&nbsp;encounters&nbsp;more&nbsp;mysterious "events&nbsp;than he&nbsp;didn't&amp;know.
                      he&nbsp;may not&amp;consider.
                    </p>
                    <p>
                      Each of the characters in this brilliant Italian comedy tries to live their lives according to their own ideas of morality.
                      according to their own ideas of morality. The protagonist, stuck in misery
                      is willing to do anything to make a name for himself. Everything is good, even
                      deceit, deception and even a little blackmail to get that comfort. But
                      the price for the illusion Pasquale creates for himself can be exorbitant, both
                      for himself and for others.
                    </p>
                    <blockquote>
                      <strong>Director Grigory Dityatkovsky on the play:</strong> "The "Ghosts"&nbsp;- a
                      rare case of impeccable drama in which the situational comedy and the comedy of the characters are
                      characters are unusually well combined.
                      Theatre&nbsp;-is&amp;the&amp;life&amp;of&amp;real&amp;life,&nbsp;-so&amp;defined&amp;the&amp;author&amp;the&amp;main&amp;line&amp;of his&amp;work.
                      But all his characters have a rare quality: they can be perceived as living
                      human being and at the same time have all the characteristics of a conventional
                      conventional comic character. They have all the characteristics of a human being, but
                      also those of a theatrical mask".
                      <br />
                      &nbsp;
                    </blockquote>
                    <h5>ACTING GHOSTS:</h5>
                    <p>
                      ...
                      <br />
                      Raffaele, Gatekeeper&nbsp;- Honoured Artist of the USFSR Mikhail Samochko
                      <br />
                      Кармела, его сестра&nbsp;- Елизавета Кизикова
                      <br />
                      Gastone Califano&nbsp;— Ruslan Meshchanov
                      <br />
                      Two removalists: Danila Pyanzin
                      <br />
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>1 hour and 50 minutes, with one interruption</p>
                      <p />
                    </div>
                  </div>
                </article>
