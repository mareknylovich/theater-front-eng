      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>These loose butterflies</h1>
            <h6 style={{ color: '#000' }}>Leonard Gersh</h6>
            <h6 style={{ color: '#000' }}>Smut Comedy, 16+</h6>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Director of Photography</strong>&nbsp;— Valeri Filonov
                    </p>
                    <p>
                      <strong>Production designe</strong>&nbsp;— Natalia Osipova
                    </p>
                    <p>
                      <strong>Composer</strong>&nbsp;— Arthur Gorbenko
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      The love story of a young man from a wealthy family and a fluttering, flamboyant girl
                      fluttering, flamboyant girl who dreams of becoming an actress.
                      a sentimental story of modern life, a famous Broadway comedy full of lively reprises and
                      Broadway comedy full of vivid reprises and dialogue, performed by masters of the stage.
                      stage. Life is not over when the girl you love is gone....
                    </p>
                    <p>&nbsp;</p>
                    <p>The 500th performance was played on 27 December 2014.</p>
                    <p>The 600th performance was played on 14 August 2017.&nbsp;</p>
                    <p>
                      <strong>The 650th performance was played on 2 November 2019.</strong>
                    </p>
                    <p />{' '}
                  </div>
                </div>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>2 hours 45 minutes with one break</p>
                      <p />
                    </div>
                  </div>
                </article>
            ...
            <div className="row row-50">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Galina Mochalova</span>
                  </h6>
                  <div className="unit-body">
                    <span>Miss Baker</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
