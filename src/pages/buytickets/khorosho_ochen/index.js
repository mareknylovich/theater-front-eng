      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>That's good. Very good!</h1>
            <h6 style={{ color: '#000' }}>Vassili Schukschin</h6>
            <h6 style={{ color: '#000' }}>Comedy, 16+</h6>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Director and production designer</strong> — Vasily Senin
                    </p>
                    <p>
                      <strong>Costume Designer</strong> — Irina Arlacheva
                    </p>
                    <p>
                      <strong>Lighting designer</strong> — Honoured Artist of Ukraine Eugene Ganzburg
                    </p>
                    <p>
                      <strong>Musical Director</strong> — Vladimir Bychkovsky
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      The production is based on five comedies by Vasily Shukshin. The characters of the play
                      are simple and unpretentious, but each of them has his own insoluble problem.
                      problem. Gleb Kapustin is waiting for a meeting with a candidate of science in order to
                      prove to him that there are great spirits in the village too. The always calm and
                      Venya Zyablitsky dares to argue with his wife and mother-in-law for the first time.
                      with his wife and mother-in-law. Andrey Yerin does not know how to tell his wife that he has lost money.
                      lost money. Sergey Dukhanin is faced with the decision of what is more important to him: half of a moped or the smile.
                      half of a moped or his wife's smile. And only old Afanasiy Deryabin has
                      no time for family dramas. He is busy with an extraordinarily important matter
                      important business: He is writing letters to the district executive asking for the
                      to name the street where he lives after himself: Afanasiy Deryabin.
                    </p>
                    <p>
                      In these everyday stories, the audience of the play finds poetry and beauty,
                      because Shukshin's portrayal of everyday life is always connected with philosophical understanding
                      and arguments about "eternal" questions of human existence. In one way or another
                      one way or another, our characters realise that the most important things in life are not possessions and money but love
                      but love, kindness and justice. And this realisation makes one
                      live well... very well!
                    </p>
                    <h6>MICROSCOPE</h6>
                    <p>
                      ...
                      <br />
                      <strong>Zoya Yerina, his wife&nbsp;</strong>— Sonja Gorelik
                      <br />
                      <strong>Petya, Son&nbsp;</strong>— Maxim Smirnov
                      <br />
                    ...
                    <p>
                      ...
                      <br />
                      <strong>The villagers</strong>&nbsp;— Vyacheslav Korobitsin&nbsp;/Alexander Lenin,
                      Sonya Gorelik, Natalia Parashkina&nbsp;/Yulia Molchanova
                    </p>
                    <h6>MY SON-IN-LAW STOLE A CART OF FIREWOOD.</h6>
                    <p>
                      ...
                      <br />
                      <strong>Judge</strong>&nbsp;— Sonja Gorelik
                      <br />
                      <strong>Public Defender</strong>&nbsp;— Denis Kirillov
                      <br />
                      <strong>Prosecutor</strong>&nbsp;— Alexander Mashanov&nbsp;/ Alexander Ronis
                    </p>
                    <h6>MUSIK DERIABIN</h6>.
                    <p>
                      <strong>Man</strong>&nbsp;— Alexander Mashanov&nbsp;/ Alexander Ronis
                      <br />
                      <strong>Squirrel&nbsp;</strong>— Sonja Gorelik
                    </p>
                    <h6>SECURITY</h6>
                    <p>
                      ...
                      <br />
                      <strong>Saleswoman</strong>&nbsp;— Sonja Gorelik
                      <br />
            ...
            <div className="row row-50">
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Andrej Jerin / Gleichaltrige / Venja Zyablizkiy / Sergey Mitbewohner</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Andrey Yerin / Peers / Venya Zyablitsky / Sergey's Roommate</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <h6 style={{ color: '#000' }}>
                    <span>Sonya Gorelik</span>
                  </h6>
                  <div className="unit-body">
                    <span>
                      Zoya Yerina, His Wife / Single Villager / Judge / Squirrel /
                      Saleswoman
                    </span>
                  </div>
                </article>
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>
                      Sergei Kulikov / Konstantin Ivanovich Zhuravlev (PhD) / Public defender / Sergei Zhuravlev
                      Dukhanin
                    </span>
                  </div>
                </article>
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>Gleb Kapustin / Prosecutor / Man / Sergei's associate</span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
              ...
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>
                      Valya Zhuravleva, his wife / Sonya Zyablitskaya, his wife / Grusha, their daughter
                    </span>
                  </div>
                </article>
              </div>
              <div className="col-md-6 col-lg-3">
                <article className="blurb blurb-circle blurb-circle_centered open-actor-win-js">
                  ...
                  <div className="unit-body">
                    <span>
                      Lizaveta Vasilievna, Vena's mother-in-law / Peers / Klavdia Dukhanina, his wife
                    </span>
                  </div>
                </article>
              </div>
