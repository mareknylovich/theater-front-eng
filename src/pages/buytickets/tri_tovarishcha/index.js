      ...
      <main className="page-content">
        ...
        <section className="section-lg bg-default text-center">
          <div className="container">
            <h1 style={{ color: '#000' }}>Three Comrades</h1>
            <h6 style={{ color: '#000' }}>Juri Smekalov, Alexander Zypkin</h6>
            <h6 style={{ color: '#000' }}>what the ballet is silent about, 18+</h6>
              ...
              <div className="col-md-4">
                <div className="row text-left">
                  <div className="col-md-12">
                    <p></p>
                    <p>
                      <strong>Playwright</strong> — Alexander Tsypkin
                    </p>
                    <p>
                      <strong>Author, director and choreographer</strong> — Yuri Smekalov
                    </p>
                    <p>
                      <strong>Production designer</strong> — Andrei Sevbo
                    </p>
                    <p>
                      <strong>Costume designer</strong> — Sergei Illarionov
                    </p>
                    <p>
                      <strong>Lighting designer</strong> — Yana Boytsova
                    </p>
                    <p>
                      <strong>Music design</strong> — Vlad Zhukov
                    </p>
                    <p />{' '}
                  </div>
                </div>
              ...
              <div className="col-md-8">
                <div className="row text-left">
                  <div className="col-md-12">
                    ...
                    <p>
                      <strong>
                        The cast includes: Yuri Smekalov (Mariinsky Theatre), Viktoria Litvinova (Bolshoi
                        Theatre), Alexander Chelidze (freelance dancer), Vitaly Kulikov (Lensoviet Theatre), Ivan
                        Batarev (Lensoviet Theatre) &nbsp;/ Anton Gulyaev (freelance actor).
                      </strong>
                    </p>
                    <strong>
                      <p>
                        Three true stories of dancers from a great musical theatre tell the
                        unvarnished story of the underside of the ballet world. What inner barriers,
                        attitudes and fears can stand in the way of recognition and success? How can
                        dancer and his or her own body become sworn enemies?
                        enemies?
                      </p>
                      <p>
                        The choreographer and director Yuri Smekalov and the well-known Russian author Alexander
                        Tsypkin, who is making his debut as a playwright, present a truthful, funny and at the same time
                        a truthful, funny and at the same time dramatic story about people who have dedicated their lives to the stage.
                        who have dedicated their lives to the stage. What does the ballet really say?
                      </p>
                      <blockquote>
                        <h6>Juri Smekalow</h6>
                        <p>
                          Soloist of the Mariinsky Theatre, winner of the National Theatre Award "Golden Mask".
                          Choreographer. He has directed at the Bolshoi and Mariinsky Theatres, at the Samara Opera and Ballet
                          and Ballet Theatre Samara and at the Vartanyan Drama Theatre. Founder and
                          artistic director of the M.&nbsp;A.&nbsp;D. Company&nbsp;- an independent
                          dance company producing ballets in&nbsp;Ukraine and&nbsp;abroad.
                        </p>
                        <h6>Alexander Zypkin</h6>
                        <p>
                          The author of the bestsellers "Women of an Indomitable Age", "Dating House", "The Girl
                          Who Always Laughed Last". The author of the project "Impersonal Readings"&nbsp;- a literary-theatrical
                          literary-theatrical format in which prose is read by authors themselves
                          and&nbsp;popular artists, including: Konstantin Khabensky, Ingeborga
                          Dapkunaite, Viktoria Isakova, Anna Mikhalkova and others. Winner of the Prize of the
                          Guild of Film Historians and Critics at the Kinotavr &nbsp;Film Festival for her
                          film Goodbye, Love, starring Ksenia Rappoport.
                        </p>
                      </blockquote>
                      <p>
                ...
                <article className="blurb blurb-minimal">
                  <div className="unit flex-row unit-spacing-md justify-content-performance">
                    ...
                    <div className="unit-body">
                      ...
                      <p></p>
                      <p>1.30 hours without interruption</p>
                      <p />
                    </div>
                  </div>
                </article>
