...
export const LOADER = ({
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Your application has been successfully registered. Expect a confirmation by e-mail.
          </Title>
        </div>
      </Cont>
    );
  ...
  const getType = () => {
    return type === '2FA' ? (
      <Cont>
        <div>
          <Title className="LR_TITLE">Confirm the login to your account</Title>
        </div>
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Enter the SMS code to access your personal account
          </Title>
        </div>
        <div>
      ...
      <Cont>
        <div>
          <Title className="LR_TITLE">
            Enter the PIN code to access your personal account
          </Title>
        </div>
        <div>
          <InputsContainer>
